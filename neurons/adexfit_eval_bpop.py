...
using traces from simulated BBP neurons *and* BluePyOpt
by Henri Hokkanen <henri.hokkanen@helsinki.fi>, May 2019
...
4) Naud et al. 2008
5) https://gist.github.com/mstimberg/fc202e19382d2344fb0b7c4b2d24a758
...
class AdexOptimizable(bpop.evaluators.Evaluator):
    """
    ...
    def __init__(self, passive_params, target_traces=MarkramStepInjectionTraces(), efel_feature_names=None, custom_feature_names=[], dendritic_extent=0, stim_total=3000, stim_start=700, stim_end=2700):
        ...
        # Call to BluePyOpt superclass
        super(AdexOptimizable, self).__init__(objectives=efel_feature_names,
                                              params=[Parameter('a', bounds=[-5, 5]),
                                                      Parameter('tau_w', bounds=[5,100]),
                                                      Parameter('b', bounds=[10,300]),
                                                      Parameter('V_res', bounds=[-70,-60])])
    ...
    def evaluate_with_lists(self, params):
        self.evaluateFitness(individual=params)
        pass
...
if __name__ == '__main__':
    ...
    init_guess = [9.3, 208, 311, -65, -55, 1.47]
